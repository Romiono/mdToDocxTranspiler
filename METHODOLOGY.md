...
**Математика:** `$...$` и `$$...$$` конвертируются в нативные Word Math объекты (OMML).
...
### 8.1 Затекстовые ссылки (ОСНОВНОЙ метод)
...
### 8.2 Формат библиографической записи по ГОСТ 7.1-2003
...
### 9.1 Принудительный разрыв страницы
...
## 10. Полный пример структуры файла ВКР
...
## 11. Чек-лист перед транспиляцией
